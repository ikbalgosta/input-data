...
<body id="b">
<form action="ftea.php" method="POST">
<header>
<center>
<div id="divheader">
<?php
...
}else{echo header("Location:ftea.php");}
...
elseif($_SESSION['section']=="Fridge"){
	...
	$count= mysqli_num_rows($record);
	if($count==0){
	$insertion= "insert into fridge (fridge_date, `fridge_rcvin`, `fridge_rcvout`, `fridge_wdonein`, `fridge_inpending`, `fridge_outpending`, `fridge_intransit`, `fridge_parts_pending`, `fridge_decision`, `fridge_red_color`, `fridge_soft_wise`, `fridge_5days`, `fridge_user`, `fridge_section`, `fridge_pointname`) Values('$bday','$rcvin','$rcvout','$wdone','$inpending','$Outpending','$intransit','$ppending','$dpending','$redindecate','$softpending','$over','$user','$section','$pointname');insert into mobile (mobile_date,mobile_pointname) VALUES('$bday','$pointname'); insert into laptop (lap_date,lap_pointname) VALUES('$bday','$pointname');";
