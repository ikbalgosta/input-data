...
?>
 ...
 if (isset($_POST['search']))
 {
	...
	$run1 = mysqli_query($con,$query);}
	 ...
	 $query1="SELECT * FROM parts_pending WHERE requisition='$blank' ";
	 $query2="SELECT * FROM parts_pending WHERE pointname='$point'";
	 $query3="SELECT * FROM parts_pending WHERE pointname='$point' AND requisition = '$blank'";
...
<table>
		...
		<td><a href ="edit_store.php?editid=<?php echo $row['id'];?>" type="button" name="sub" >Add Req.</a></td>
