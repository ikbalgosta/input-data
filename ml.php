...
}else{echo header("Location:ml.php");}
...
elseif($_SESSION['section']=="Fridge"){
	...
	$count= mysqli_num_rows($record);
	if($count==0){
	$insertion= "insert into fridge (fridge_date, `fridge_rcvin`, `fridge_rcvout`, `fridge_wdonein`, `fridge_inpending`, `fridge_outpending`, `fridge_intransit`, `fridge_parts_pending`, `fridge_decision`, `fridge_red_color`, `fridge_soft_wise`, `fridge_5days`, `fridge_user`, `fridge_section`, `fridge_pointname`) Values('$bday','$rcvin','$rcvout','$wdone','$inpending','$Outpending','$intransit','$ppending','$dpending','$redindecate','$softpending','$over','$user','$section','$pointname'); insert into ac (ac_date,ac_pointname) VALUES('$bday','$pointname');";
	
	$query_run= mysqli_multi_query($con,$insertion);
...
elseif($_SESSION['section']=="Cellphone"){
	...
	$count= mysqli_num_rows($record);
	if($count==0){
	$insertion= "insert into mobile (`mobile_date`, `mobile_rcvin`, `mobile_rcvout`, `mobile_wdonein`, `mobile_inpending`, `mobile_outpending`, `mobile_intransit`, `mobile_parts_pending`, `mobile_decision`, `mobile_red_color`, `mobile_soft_wise`, `mobile_5days`, `mobile_user`, `mobile_section`, `mobile_pointname`) Values('$bday','$rcvin','$rcvout','$wdone','$inpending','$Outpending','$intransit','$ppending','$dpending','$redindecate','$softpending','$over','$user','$section','$pointname'); insert into ac (ac_date,ac_pointname) VALUES('$bday','$pointname'); insert into fridge (fridge_date,fridge_pointname) VALUES('$bday','$pointname'); insert into emh (emh_date,emh_pointname) VALUES('$bday','$pointname'); insert into tv (tv_date,tv_pointname) VALUES('$bday','$pointname');";
$query_run= mysqli_multi_query($con,$insertion);
