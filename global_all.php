...
if(isset($_POST['submit'])){
	 $d=$_POST['bday'];
	 	...
	 	$query1 = "SELECT * FROM fridge,tv,emh,mobile,laptop,ac,main WHERE PointName = fridge_pointname  AND PointName = tv_pointname AND PointName = emh_pointname AND PointName = mobile_pointname AND PointName = lap_pointname  AND PointName= ac_pointname";
	...
	?>
		<tr>
			<td><?php echo $i++ ?></td>
			<td>Zone</td>
			<td><?php echo $row['fridge_pointname'];?></td>
			...
			<td><?php echo $row['ac_rcvin'];?></td>
			<td><?php echo $row['ac_rcvout'];?></td>
			<td><?php echo $row['ac_wdonein'];?></td>
			<td><?php echo $row['ac_inpending'];?></td>
			<td><?php echo $row['ac_outpending'];?></td>
			<td><?php echo $row['ac_intransit'];?></td>
			<td><?php echo $row['ac_parts_pending'];?></td>
			<td><?php echo $row['ac_decision'];?></td>
			<td><?php echo $row['ac_red_color'];?></td>
			<td><?php echo $row['ac_soft_wise'];?></td>
			<td><?php echo $row['ac_5days'];?></td>
